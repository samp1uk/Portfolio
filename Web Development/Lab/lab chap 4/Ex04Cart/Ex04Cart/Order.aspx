                ...
                <div class="col-sm-8"><%-- product drop down and info column --%>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:Halloween_Con %>' SelectCommand="SELECT [ProductID], [Name], [ShortDescription], [LongDescription], [ImageFile], [UnitPrice] FROM [Products] ORDER BY [Name]"></asp:SqlDataSource>
                        </div>
                    </div>   
                    <div class="form-group">
