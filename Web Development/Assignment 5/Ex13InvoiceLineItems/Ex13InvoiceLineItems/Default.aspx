        ...
        <form id="form1" runat="server" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-xs-8 col-sm-5">
                    ...
                    <asp:DropDownList ID="ddlInvoice" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource" DataTextField="InvoiceNumber" DataValueField="InvoiceNumber"  CssClass="form-control">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:HalloweenConnection %>" SelectCommand="SELECT [InvoiceNumber] FROM [Invoices] WHERE ([Total] &gt; @Total)">
                        <SelectParameters>
            ...
            <div class="form-group">
                <div class="col-xs-12 col-sm-offset-1 col-sm-9">
                    ...
                    <asp:DataList ID="dlLineItems" runat="server" DataSourceID="SqlDataSource1" CssClass="table table-bordered table-condensed">
                        <HeaderTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HalloweenConnection %>" SelectCommand="SELECT [ProductID], [UnitPrice], [Quantity], [Extension] FROM [LineItems] WHERE ([InvoiceNumber] = @InvoiceNumber)">
                        <SelectParameters>
